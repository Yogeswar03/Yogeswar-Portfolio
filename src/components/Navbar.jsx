...
function Navbar() {
  ...
  return (
    <nav
      className={`w-full h-[8vh] z-[999] fixed top-0 left-0 backdrop-blur-[7px] flex items-center justify-between font-light font-["Neue_Montreal"] transition-transform duration-300 ${
      ...
      <div className='sm:flex hidden gap-x-[20px] w-[50%] font-light'>
        {['About', 'Projects', 'Skills', 'Experience', 'Contact'].map((item, index) => (
          <a
            ...
            key={index}
            className={`w-fit font-lg capitalize flex flex-col ${index === 4 && 'px-50'}`}
          >
