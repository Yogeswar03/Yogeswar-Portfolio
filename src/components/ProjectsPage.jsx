      ...
      <div ref={scrollRef} className='w-full  font-["Neue_Montreal"] overflow-hidden'>
       ...
       <div className='px-5 md:px-20 '>
          <div className='cards flex flex-wrap justify-center items-center gap-5 mt-10 lg:mt-10 '>   
                <div className='card-1 w-full sm:w-[calc(50%-10px)] lg:w-[calc(49%-10px)] h-[83vh] flex flex-col mt-15 lg:mt-[130px] '>
                ...
                <div className='card-5 w-full sm:w-[calc(50%-10px)] lg:w-[calc(49%-10px)] h-[82vh] -mt-70 lg:mt-20 '>
                          <div className='name flex gap-2 items-center justify-start pb-3 '>
                            <span className='w-3 h-3 rounded-full bg-black'></span>
                          ...
                          >
                            ...
                            <div className='absolute z-10 p-10  object-contain'>
                              <a href="https://github.com/Yogeswar03/Movie-Review-using-NLP" target='_blank'>
                                <img src="/projectImages/movie.png" alt="movie review" className='rounded-xl h-[27vh] md:h-[45vh] lg:h-[55vh]  ' />
                              </a>
                            </div>
                          </motion.div>
                ...
                <div className='card-6 w-full sm:w-[calc(50%-10px)] lg:w-[calc(49%-10px)] h-[82vh] -mt-70 lg:mt-20 '>
                          <div className='name flex gap-2 items-center justify-start pb-3'>
                            <span className='w-3 h-3 rounded-full bg-black'></span>
                          ...
                          >
                            ...
                            <div className=' absolute p-10  object-contain'>
                              ...
                              <img src="/projectImages/digit.png" alt="Digit scan" className='rounded-xl h-[27vh] md:h-[45vh] lg:h-[55vh]  top-1/2 left-1/2 ' />
                              </a>
                            </div>
                          </motion.div>
                          <div className='flex gap-2 mt-4 items-center justify-start'>
                ...
                <div className='card-7 w-full sm:w-[calc(50%-10px)] lg:w-[calc(49%-10px)] h-[82vh] -mt-70 lg:mt-20'>
                                      <div className='name flex gap-2 items-center justify-start pb-3'>
                                        <span className='w-3 h-3 rounded-full bg-black'></span>
                                       ...
                                       <div>                
                                        ...
                                        <div className='absolute z-10 object-contain p-10'>
                                          <a href="https://github.com/Yogeswar03/Expense-Tracker" target='_blank'>
                                            <img src="/projectImages/expense.png" alt="Expense Tracker" className='rounded-xl  h-[27vh] md:h-[45vh] lg:h-[55vh]' />
                                          </a>
                                        </div>
                                      </motion.div>
                                      <div className='flex gap-2 mt-4 items-center justify-start'>
                ...
                <div className='card-8 w-full sm:w-[calc(50%-10px)] lg:w-[calc(49%-10px)] h-[82vh] -mt-70 lg:mt-20'>
                          <div className='name flex gap-2 items-center justify-start pb-3'>
                            <span className='w-3 h-3 rounded-full bg-black'></span>
                          ...
                          >
                            ...
                            <div className='absolute  z-10 pl-10 lg:pl-15 p-10 object-contain'>
                              <a href="https://github.com/Yogeswar03/Random-Password-Generator" target='_blank'>
                                <img src="/projectImages/image.png" alt="random password" className='rounded-xl  h-[27vh] md:h-[45vh] lg:h-[55vh]' />
                              </a>
                            </div>
                          </motion.div>
                          <div className='flex gap-2 mt-4 items-center justify-start'>
                ...
                <div className='card-9 w-full sm:w-[calc(50%-10px)] lg:w-[calc(49%-10px)] h-[82vh] -mt-70 lg:mt-20'>
                                      <div className='name flex gap-2 items-center justify-start pb-3'>
                                        <span className='w-3 h-3 rounded-full bg-black'></span>
                                       ...
                                       <div>                
                                        ...
                                        <div className='absolute z-10 object-contain p-10'>
                                          <a href="https://github.com/Yogeswar03/8Puzzle" target='_blank'>
                                            <img src="/projectImages/puzzle.png" alt="Expense Tracker" className='rounded-xl  h-[27vh] md:h-[45vh] lg:h-[55vh] ' />
                                          </a>
                                        </div>
                                      </motion.div>
                                      <div className='flex gap-2 mt-4 items-center justify-start'>
                ...
                <div className='card-10 w-full sm:w-[calc(50%-10px)] lg:w-[calc(49%-10px)] h-[82vh] -mt-70 lg:mt-20 '>
                          <div className='name flex gap-2 items-center justify-start pb-3'>
                            <span className='w-3 h-3 rounded-full bg-black'></span>
                          ...
                          >
                            ...
                            <div className='absolute  z-10   pl-12  p-10 object-contain'>
                              <a href="https://github.com/Yogeswar03/IOT-based-Smart-Home-Security-prototype-using-alert-system" target='_blank'>
                                <img src="/projectImages/smarthouse.png" alt="random password" className='rounded-xl  h-[27vh] md:h-[45vh] lg:h-[55vh]' />
                              </a>
                            </div>
                          </motion.div>
                          <div className='flex gap-2 mt-4 items-center justify-start'>
